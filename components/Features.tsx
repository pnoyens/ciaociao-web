...
export default function Features() {
  return (
    <section className="bg-white border-t border-black py-12 md:py-[100px]" id="features">
          ...
          {features.map((feature, index) => (
            <div key={index} className="flex flex-col sm:flex-row items-start bg-cc-card card-shadow">
              ...
              <div className="flex-1 py-6 px-5 sm:py-8 sm:pr-6 sm:pl-10 md:py-10 md:pr-[30px] md:pl-20 flex flex-col gap-2 md:gap-3">
                <h3 className="font-serif text-xl md:text-[28px] font-semibold text-cc-dark leading-tight">{feature.title}</h3>
                <p className="text-sm md:text-base font-light leading-relaxed text-cc-dark">{feature.description}</p>
