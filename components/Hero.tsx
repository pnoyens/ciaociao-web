...
export default function Hero() {
  return (
    <section className="pt-[120px] pb-[60px] md:pt-[155px] md:pb-[120px] min-h-screen bg-background dot-pattern relative">
      {/* Gradient overlay to fade dot pattern from right to left, starting at middle */}
      <div className="absolute inset-0 bg-[linear-gradient(to_left,transparent_0%,transparent_50%,var(--background)_65%)] pointer-events-none" />
